...
contract BebopSettlement is IBebopSettlement, BebopSigning, BebopTransfer {
    ...
    function settleSingle(
        ...
        _validateTakerSignatureForSingleOrder(
            order,
            takerSignature,
            takerQuoteInfo
        );
    ...
    //     Signature.PermitSignature calldata takerPermitSignature
    // ) external payable override {
    //     _validateTakerSignatureForMultiOrder(
    //         order,
    //         takerSignature,
    //         takerQuoteInfo
    //     );
    ...
    function _executeSingleOrder(
        ...
        ) = Order.extractSingleOrderCommands(order.packed_commands);
        if (
            takerTransferCommand == Commands.TRANSFER_FROM_CONTRACT &&
            takerHasNative
        ) {
        ...
        if (filledTakerAmount != 0 && filledTakerAmount < order.taker_amount) {
            newMakerAmount =
                (updatedMakerAmount * filledTakerAmount) /
                order.taker_amount;
        }
    ...
    //             order.maker_address,
    //             order.receiver,
    //             order.maker_tokens[0],
    //             updatedMakerAmounts[0],
    //             makerUsingPermit2
    //                 ? Commands.PERMIT2_TRANSFER
    //                 : Commands.SIMPLE_TRANSFER,
    //             order.commands[0] == Commands.NATIVE_TRANSFER
    //                 ? Transfer.Action.Unwrap
    ...
    //             order.taker_address,
    //             order.maker_address,
    //             order.taker_tokens[0],
    //             filledTakerAmount == 0 ||
    //                 filledTakerAmount > order.taker_amounts[0]
    //                 ? order.taker_amounts[0]
    //                 : filledTakerAmount,
    //             takerCommand,
    //             takerCommand == Commands.NATIVE_TRANSFER
    ...
    //                 makerAmounts[j] =
    //                     (updatedMakerAmounts[j] * filledTakerAmount) /
    //                     order.taker_amounts[0];
    //             }
    //         }
